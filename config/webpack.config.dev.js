...
let config = {
    ...
    module: {
        rules: [
            ...
            registRule.js(),
            registRule.vue({ sourceMap, extract, modules: false, src, minimize }), //langs: ['less','sass','css'],
            registRule.less({ sourceMap, extract, modules: false, src, exclude, minimize }),
            registRule.sass({ sourceMap, extract, modules: false, src, exclude, minimize }),
            registRule.css({ sourceMap, extract, modules: false, src, exclude, minimize }),
            /*global*/
