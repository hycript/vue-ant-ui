...
module.exports = class Service {
    ...
    resolvePlugins(inlinePlugins, useBuiltIn) {
        ...
        const builtInPlugins = [
            ...
            '@vue/cli-service/lib/config/dev',
        ...
        if (this.pkg.vuePlugins && this.pkg.vuePlugins.service) {
            ...
            plugins = plugins.concat(files.map(file => ({
                id: `local:${file}`,
                apply: loadModule(`@vue/cli-service/lib/${file}`, this.pkgContext)
            })))
        }
    ...
    loadUserOptions() {
        ...
        console.error('__dirname', __dirname, this.context);
        const configPath = path.resolve(this.context, process.env.VUE_CLI_SERVICE_CONFIG_PATH || 'vue.config.js');
